...
export function Settings() {
  ...
  return (
    <>
      <button type="button" title="settings" role="button" onClick={handleClick} className="transition duration-200 focus:outline-none rounded-md hover:text-gray-400 focus:text-blue-400">
