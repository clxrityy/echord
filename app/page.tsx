...
export default async function Home() {
  ...
  return <main className="w-full h-full relative items-center justify-center mx-auto flex flex-col gap-10">
    {/**
     *
     */}
    <div className="w-full h-full relative flex flex-col xl:flex-row gap-5 items-start justify-start xl:justify-between xl:items-start xl:gap-0">
