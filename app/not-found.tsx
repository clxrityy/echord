    ...
    <div className="font-[var(--font-tmr)] w-full h-full flex items-center justify-center gap-4 bg-black/35 backdrop-blur-sm">
      <div className="relative flex justify-center items-center w-full">
        <div className="flex flex-col items-center justify-center w-full h-full gap-10">
          ...
          <Button>
            <Link href={"/"} className="flex items-center justify-center bg-[var(--color-blue-popsicle)]/25 hover:bg-[var(--color-blue-popsicle)]/50 focus:bg-[var(--color-blue-popsicle)]/75 transition-colors focus:ring ease-out px-6 py-2 rounded-lg">
